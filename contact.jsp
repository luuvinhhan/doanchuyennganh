                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <td>Họ và tên *  </td>
                                        <input class="form-control valid" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Họ và tên'" placeholder="Họ và tên ">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <td>Số điện thoại *</td>
                                        <input class="form-control valid" name="sdt" id="email" type="sdt" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Số điện thoại'" placeholder="Số điện thoại">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="text" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Địa chỉ cụ thể'" placeholder="Địa chỉ cụ thể">
                                    </div>
                                </div>  
                                <div class="col-12">
                                    <div class="form-group">
                                        <td>Ghi chú </td>
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Ghi chú'" placeholder="Ghi chú "></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3" align="center" >
                                <button type="submit" style="background-color:#000080; width: 500px ; height: 50px ;  border: 0 ">  GỬI </button>
                            </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>124 Điện Biên Phủ, Phường Đakao, Quận 1,TP.HCM</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                            <div class="media-body">
                                <h3>(+84) 982-278 356</h3>
                                <p>06:00 AM - 18:00 PM</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>shionhouse@gmail.com</h3>
