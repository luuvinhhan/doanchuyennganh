                        ...
                        <div class="header-left d-flex align-items-center">
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav><ul id="navigation">
                                        ...
                                        <li><a href="sanpham">SẢN PHẨM </a><ul class="submenu">
        ...
        <div class="about-area">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-tittle mb-60 text-center pt-10">
                            <h2>Our Story</h2>
                            <p class="pera">Cảm hứng mùa Hè trong Natural ambience không chỉ được thể hiện qua họa tiết in trên áo, mà còn bởi những thay đổi trong bảng màu và chất liệu vải tự nhiên phù hợp với tiết trời nắng nóng.</p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-tittle mb-60 text-center pt-10">
                            ...
                            <p class="pera">Bộ ảnh được chúng tôi thực hiện vào một ngày cuối tháng 4 tại nơi mà quang cảnh thiên nhiên vẫn còn hoang sơ và vô cùng ấn tượng. Tuy nhiên dịch bệnh căng thẳng hơn khiến chúng ta phải tiết chế lại những chuyến đi. Vậy hãy cùng Highway trải nghiệm vẻ đẹp hùng vĩ cùng không khí miền biển, tận hưởng khoảnh khắc tự do mà thiên nhiên và tình yêu mang lại qua Collection lần này.</p>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="about-img pb-bottom">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-tittle mb-60 text-center pt-10">
                            <h2>SHIONHOUE'S TEAM</h2>
                            <p class="pera">Creative: Viet Anh</p>
                            <p class="pera"> Stylist: Thanh Huong</p>
                            <p class="pera">Photography: Quang Minh</p>
                            <p class="pera">Models: Badgal TinTins, Athony Hoang</p>
                            <p class="pera">Content & Designer Graphic : Han, Nam Phuong Nam<p>
                        </div>
                    </div>
                </div>
            </div>
